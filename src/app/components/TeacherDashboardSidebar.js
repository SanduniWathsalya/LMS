...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full bg-white text-black border-r border-gray-300 p-5 w-64 md:flex md:flex-col transition-transform transform ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 md:relative`}
      >
        
        <h2 className="text-2xl font-semibold text-center text-yellow-400   mb-6">GenzEdu</h2>
        <nav className="flex flex-col gap-4">
          <Link href="/" className="flex items-center px-4 py-2 bg-gray-200  hover:bg-gray-200 rounded-md">
          ...
          <Link href="/users" className="flex items-center px-4 py-2  hover:bg-gray-200 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" strokewidth="1.5"
            stroke="currentColor" className="w-4 mr-3">
          ...
          <Link href="/settings" className="flex items-center px-4 py-2  hover:bg-gray-200 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokewidth="1.5"
            stroke="currentColor" className="w-4 mr-3">
            <path strokelinecap="round" strokelinejoin="round"
