...
import Sidebar from "../components/TeacherDashboardSidebar";
...
const Dashboard = () => {
  return (
    <main>
      <div className="flex h-screen bg-gray-100">
        ...
        <div className="flex flex-col flex-1 overflow-y-auto">
          <div className="flex items-right h-12 bg-white border-b border-gray-200">
    ...
    <div className="flex flex-col gap-8 w-full h-auto mt-5">
    {/*User Activity*/}
    <div className="flex justify-between gap-8 sm:grid-cols-3 mt-5 w-full h-auto ">
  {/* User Activity Section */}
  <div className="bg-white mt-5 flex-[2] min-w-[600px] border rounded-sm overflow-hidden shadow">
    <h1 className="text-2xl font-bold text-center text-black mt-5">User Activity</h1>
    <UserActivityChart />
  </div>

  {/* Top Courses Section */}
  <div className="bg-white mt-5 gap-12 flex-1 min-w-[200px] border rounded-sm overflow-hidden shadow">
    <h1 className="text-2xl font-bold text-center text-black mt-5">Top Courses</h1>
    <TopCourses />
  </div>

  {/* Top Users Section */}
  <div className="bg-white mt-5 flex-1 min-w-[300px] border rounded-sm overflow-hidden shadow">
    <h1 className="text-2xl font-bold text-center text-black mt-5">Top Users</h1>
    {/* Add your Top Users content here */}
    <TopUsers />
  </div>
</div>
