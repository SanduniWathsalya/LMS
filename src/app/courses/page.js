...
import TabHeader from '../components/CoursesHeader';
import TabContent from '../components/CoursesContent';
...
export default function Courses() {
  ...
  return (
    ...
    <div className=" bg-gray-100">
      ...
      <div className="bg-gray-100 p-4 max-w-6xl mx-auto rounded-md shadow">
